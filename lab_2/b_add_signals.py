...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonComboBox.clicked.connect(self.onPushButtonComboBox)  # TODO подключить слот для вывода текста из comboBox в plainTextEditLog при нажатии на кнопку
        ...
        self.comboBox.textActivated.connect(self.changeComboBox)  # TODO подключить слот для вывода текста в plainTextEditLog при изменении выбранного элемента в comboBox
        ...
        self.dateTimeEdit.dateTimeChanged.connect(self.changeDateTime)  # TODO подключить слот для вывода датывремени в plainTextEditLog при изменении датывремени в dateTimeEdit

    # slots --------------------------------------------------------------
    def onPushButtonComboBox(self) -> None:
        """
    ...
    def changeComboBox(self) -> None:
        """
        Обработка сигнала при изменении выбранного элемента в comboBox
    ...
    def changeSpinBox(self) -> None:
        """
        Обработка сигнала при изменении выбранного элемента в SpinBox
    ...
    def changeDateTime(self) -> None:
        """
        Обработка сигнала при изменении выбранного элемента в DateTime
